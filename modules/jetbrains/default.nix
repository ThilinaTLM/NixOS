...
let 
   inherit (pkgs) lib stdenv callPackage fetchurl jdk zlib python3 lldb dotnet-sdk_7 maven openssl expat libxcrypt libxcrypt-legacy fontconfig libxml2 runCommand musl R libgcc lttng-ust_2_12 xz xorg libGL;
in
